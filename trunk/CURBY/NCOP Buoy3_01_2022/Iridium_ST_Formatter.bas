...
' Create a station global variable for 2nd station ID
Static stationID2 = ""

' Open the station2.dat file and update the COMSTag to the last known
' station 2 ID.
F1 = FreeFile
DATASTR = ""
OPEN "station2.dat" For Input As F1                                                                                         
stationID2 = ReadB(F1, DATASTR, 1000)
CLOSE F1
...
Public FUNCTION ALARM_iATONFormatter(Group)
   ...
   'PRINT F3, "CAaa0301xx";
   StatusMsg "Station ID: "&stationID2
   Print F3, "CA";stationID2;
