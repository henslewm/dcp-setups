...
'------------------------------------------------------------------------------
'
Public Function ALARM_SBDFormatter(Group)
...
'  -0.129  -0.068  -0.004 140.0 139.0 139.0
   ...
   StatusMsg "Formatter: "&DATASTR
   ALARM_SBDFormatter = DATASTR
   
   'Not sure if this line is necessary but it clears the alarm.
   ClearAlarm
